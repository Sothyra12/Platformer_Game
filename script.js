...
// class to define the checkpoint or the flag that the player needs to reach to win the game logic
class CheckPoint {
  constructor(x, y, z) {
    this.position = {
      x,
...
const animate = () => {
  ...
  // fix the issue as the player is not colliding with the platform but rather the player is going through the platform
  platforms.forEach((platform) => {
  ...
  checkpoints.forEach((checkpoint, index, checkpoints) => {
    ...
    // every method to check if all the rules in the array are true
